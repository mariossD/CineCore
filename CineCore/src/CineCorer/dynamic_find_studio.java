...
public class dynamic_find_studio extends javax.swing.JFrame {
    String name;
   
    public dynamic_find_studio() {
        initComponents();
         mylist();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("<html><center><strong> Επέλεξε έναν από τους διαθέσιμος τίτλους για να δείς σε ποία Studio γυρίστηκε. </center></strong></html>");
