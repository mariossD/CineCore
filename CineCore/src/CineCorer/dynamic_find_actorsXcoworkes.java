...
public class dynamic_find_actorsXcoworkes extends javax.swing.JFrame {
    String crname;
   
    public dynamic_find_actorsXcoworkes() {
        initComponents();
        mylist();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("<html><center><strong> Επέλεξε έναν από τα διαθέσιμα μέλη της δημιουργικής ομάδας για να δείς με ποιούς ηθοποιούς έχει συνεργαστεί.\n</center></strong></html>");
    ...
    void getactorXcoworkers(){
        try{ 
             crname=(String) jComboBox1.getSelectedItem();
             DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
             model.setRowCount(0);
             PreparedStatement stmt = dbConnection.prepareStatement("SELECT * FROM get_actorXcoworkers(?)");
