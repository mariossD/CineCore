...
public class dynamic_find_cast extends javax.swing.JFrame {
    String mvname;
    
    public dynamic_find_cast() {
        initComponents();
         mylist();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("<html><center><strong> Επέλεξε έναν από τους διαθέσιμος τίτλους για να δείς το Casting της </center></strong></html>");
    ...
    public static void main(String args[]) {
     ...
     void getCasting(){
        try{ 
             mvname=(String) jComboBox1.getSelectedItem();
