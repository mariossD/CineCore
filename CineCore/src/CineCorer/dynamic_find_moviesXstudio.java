...
public class dynamic_find_moviesXstudio extends javax.swing.JFrame {
     String studio;
  
    public dynamic_find_moviesXstudio() {
        initComponents();
        mylist();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("<html><center><strong> Επέλεξε έναν από τα διαθέσιμα Studio για να δείς ποιές ταινίες έχουν γυριστεί σε αυτό </center></strong></html>");
    ...
    void get_find_moviesxstudio(){
        try{ 
             studio=(String) jComboBox1.getSelectedItem();
             DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
             model.setRowCount(0);
             PreparedStatement stmt = dbConnection.prepareStatement("SELECT * FROM get_find_moviesXstudio(?)");
             stmt.setString(1, studio);
             ResultSet rs =stmt.executeQuery();
             while (rs.next()) {
                String acname = rs.getString("mname");
