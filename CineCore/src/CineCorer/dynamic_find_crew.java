...
public class dynamic_find_crew extends javax.swing.JFrame {
    String movie;
    String role;
    String cname;
   
    public dynamic_find_crew() {
        initComponents();
        mylist();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("<html><center><strong> Επέλεξε έναν από τους διαθέσιμος τίτλους για να δείς την δημιουργίκη ομάδα  της </center></strong></html>");
    ...
    void getfindcrew(){
        try{ 
             ...
             while (rs.next()) {
                ...
                role = rs.getString("crole");
                model.addRow(new Object[]{ cname,role});
             }
