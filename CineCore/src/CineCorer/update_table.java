...
public class update_table extends javax.swing.JFrame {
   ...
   int index;
    ...
    private void initComponents() {
        ...
        jLabel1.setText("<html><center><strong>Επιλέξτε τον πίνακα που θέλετε να ενημερώσετε.</center></strong></html>");

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Ενημέρωση Πίνακα Ηθοποιοί.", "Ενημέρωση Πίνακα Ταινίες.", "Ενημέρωση Πίνακα Studio.", "ΕνημέρωσηΠίνακα Δημιουργική Ομάδα." }));
