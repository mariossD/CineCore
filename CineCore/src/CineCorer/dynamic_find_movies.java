...
public class dynamic_find_movies extends javax.swing.JFrame {
     String actor;
    
    public dynamic_find_movies() {
        initComponents();
        mylist();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("<html><center><strong> Επέλεξε έναν από τους διαθέσιμος/μες ηθοποιούς για να δείς σε ποίες ταινίες συμμετέχει</center></strong></html>");
  ...
  try{
    ...
    public static void main(String args[]) {
     ...
     void get_find_movies(){
        try{ 
             actor=(String) jComboBox1.getSelectedItem();
             DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
             model.setRowCount(0);
             PreparedStatement stmt = dbConnection.prepareStatement("SELECT * FROM get_find_movies(?)");
             stmt.setString(1, actor);
             ResultSet rs =stmt.executeQuery();
             while (rs.next()) {
                String movie = rs.getString("mname");
                model.addRow(new Object[]{ movie});
             }
